...
class VentaFactura(Base):
    ...
    setato_excluida = Column(Boolean, nullable=False, default=False)
    setato_actualizado_por = Column(String(160), nullable=True)
    setato_actualizado_at = Column(DateTime, nullable=True)
